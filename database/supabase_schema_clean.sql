-- LogiScore Database Schema for Supabase (Clean Version)
...
DROP TABLE IF EXISTS review_category_scores CASCADE;
...
CREATE INDEX idx_branches_freight_forwarder_id ON branches(freight_forwarder_id);
...
COMMENT ON COLUMN users.reset_token IS 'Reset token for password reset functionality';
